/**
 * jspsych-quadruple-temporal-images
 * Josh de Leeuw
 *
...
jsPsych.plugins["quadruple-temporal-images"] = (function() {

    var plugin = {};

    jsPsych.pluginAPI.registerPreload('quadruple-temporal-images', 'stimulus', 'image');

    plugin.info = {
        name: 'quadruple-temporal-images',
        description: '',
        parameters: {
            disp_func: {
            ...
            randomize: {
                ...
                default: true,
                description: 'If true, first-second stimuli position '
                	        +'are randomized.'
            },
            canvasId: {
    ...
    plugin.trial = function(display_element, trial) {
        ...
        if(trial.canvasId !== false) {
            ...
            trial.canvasId = '#jspsych-quadruple-temporal-images';
        ...
        var html = '<img id="im0" width="256" height="256" src="'
                    +trial.stimulus[trial.quadruplet[
                    		imgs_idx[first_second_idx[0]][
                    			rdm_order_first[0]]]]+'"style="display:none">';
        html += '<img id="im1" width="256" height="256" src="'
                    +trial.stimulus[trial.quadruplet[
                    		imgs_idx[first_second_idx[0]][
                    			rdm_order_first[1]]]]+'"style="display:none">';
        html += '<img id="im2" width="256" height="256" src="'
                    +trial.stimulus[trial.quadruplet[
                    		imgs_idx[first_second_idx[1]][
                    			rdm_order_second[0]]]]+'"style="display:none">';
        html += '<img id="im3" width="256" height="256" src="'
                    +trial.stimulus[trial.quadruplet[
                    		imgs_idx[first_second_idx[1]][
                    			rdm_order_second[1]]]]+'"style="display:none">';
        if(trial.mask == true){
        ...
        html += '<div id="jspsych-quadruple-temporal-images">'+canvas+'</div>';
        ...
        var after_response = function(info) {
            ...
            display_element.querySelector('#jspsych-quadruple-temporal-images')
                            .className += ' responded';
