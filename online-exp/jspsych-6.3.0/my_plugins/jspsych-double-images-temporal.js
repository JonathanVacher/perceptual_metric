/**
 * jspsych-double-images-temporal
 * Josh de Leeuw
 *
...
jsPsych.plugins["double-images-temporal"] = (function() {

    var plugin = {};

    jsPsych.pluginAPI.registerPreload('double-images-temporal', 'stimulus',
                                      'image');

    plugin.info = {
        name: 'double-images-temporal',
        description: '',
        parameters: {
            disp_func: {
    ...
    plugin.trial = function(display_element, trial) {
        ...
        if(trial.canvasId !== false) {
            ...
            trial.canvasId = '#jspsych-double-images-temporal';
        ...
        var html = '<img id="im0" width="256" height="256" src="'
                    +trial.stimulus[
                    	trial.doublet[first_second_idx[0]]]
                    +'"style="display:none">';
        ...
        html += '<div id="jspsych-double-images-temporal">'+canvas+'</div>';
        ...
        var after_response = function(info) {
            ...
            display_element.querySelector('#jspsych-double-images-temporal')
                            .className += ' responded';
